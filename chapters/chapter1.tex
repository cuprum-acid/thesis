...
\textbf{Chapter 3 — Methodology}: Describes the design of both the CRD/Operator-based system and the traditional baseline system. Details the business logic domain selected for implementation and architectural decisions.
